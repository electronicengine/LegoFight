...
LegoFightRootPath=/home/yusuf/Documents/Unreal Projects/LegoFight

gameProjectFile=/home/yusuf/Documents/Unreal Projects/LegoFight/LegoFight.uproject
...
include(LegoFightSource.pri)
include(LegoFightHeader.pri)
include(LegoFightConfig.pri)
include(LegoFightIncludes.pri)
include(LegoFightDefines.pri)

LegoFight-Linux-Debug.commands = $$build LegoFight Linux Debug  -project="\"$$gameProjectFile\"" $$args
LegoFight-Linux-DebugGame.commands = $$build LegoFight Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
LegoFight-Linux-Shipping.commands = $$build LegoFight Linux Shipping  -project="\"$$gameProjectFile\"" $$args
LegoFight-Linux-Test.commands = $$build LegoFight Linux Test  -project="\"$$gameProjectFile\"" $$args
LegoFight.commands = $$build LegoFight Linux Development  -project="\"$$gameProjectFile\"" $$args

LegoFightEditor-Linux-Debug.commands = $$build LegoFightEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
LegoFightEditor-Linux-DebugGame.commands = $$build LegoFightEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
LegoFightEditor-Linux-Shipping.commands = $$build LegoFightEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
LegoFightEditor-Linux-Test.commands = $$build LegoFightEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
LegoFightEditor.commands = $$build LegoFightEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	LegoFight-Linux-Debug \
	LegoFight-Linux-DebugGame \
	LegoFight-Linux-Shipping \
	LegoFight-Linux-Test \
	LegoFight \
	LegoFightEditor-Linux-Debug \
	LegoFightEditor-Linux-DebugGame \
	LegoFightEditor-Linux-Shipping \
	LegoFightEditor-Linux-Test \
	LegoFightEditor \
