...
LegoFight-Linux-Debug:
	 $(PROJECTBUILD) LegoFight Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

LegoFight-Linux-DebugGame:
	 $(PROJECTBUILD) LegoFight Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

LegoFight-Linux-Shipping:
	 $(PROJECTBUILD) LegoFight Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

LegoFight-Linux-Test:
	 $(PROJECTBUILD) LegoFight Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

LegoFight:
	 $(PROJECTBUILD) LegoFight Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

LegoFightEditor-Linux-Debug:
	 $(PROJECTBUILD) LegoFightEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

LegoFightEditor-Linux-DebugGame:
	 $(PROJECTBUILD) LegoFightEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

LegoFightEditor-Linux-Shipping:
	 $(PROJECTBUILD) LegoFightEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

LegoFightEditor-Linux-Test:
	 $(PROJECTBUILD) LegoFightEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

LegoFightEditor:
	 $(PROJECTBUILD) LegoFightEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
