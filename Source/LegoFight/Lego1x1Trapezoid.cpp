...
ALego1x1Trapezoid::ALego1x1Trapezoid()
{
    ...
    Begining_Pivot = FVector(25, 25, 50.7f);
...
void ALego1x1Trapezoid::BeginPlay()
{
    Super::BeginPlay();
...
// Called every frame
void ALego1x1Trapezoid::Tick(float DeltaTime)
{
