...
#include "Lego05x05Comp.h"

ALego05x05Comp::ALego05x05Comp()
{
    ...
    //    static_mesh_asset(TEXT("StaticMesh'/Game/bricks/meshes/lego_05x05_all.lego_05x05_all'"));
    ...
    //Collision_Box->SetRelativeLocation(FVector(-12.51495f, -12.462021f, -4.505463f));
    //Collision_Box->SetRelativeScale3D(FVector(0.348109f, 0.359798f, 0.448889f));
